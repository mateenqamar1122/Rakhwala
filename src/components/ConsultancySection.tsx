...
const ConsultancySection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const submissionData: Database['public']['Tables']['consultation_requests']['Insert'] = {
      ...
      const { error } = await (supabase.from('consultation_requests') as any).insert([submissionData]);
