              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <motion.div
                    ...
                    transition={{ duration: 0.2 }}
                  >
                    <Button variant="ghost" className="relative h-10 w-10 rounded-full ml-2 ring-1 ring-white/20 hover:ring-white/40 transition-all duration-200">
              ...
              {user && profile ? (
                  ...
                  <div className="px-3 py-2 border-t border-border">
                    ...
                    >
                      <Button
                        onClick={() => signOut()}
                        variant="outline"
                        className="w-full hover:bg-red-500/10 hover:border-red-500/30 transition-all duration-200"
                      >
                ...
                >
                  <Button
                    ...
                    className="mt-3 w-full inline-flex items-center justify-center px-6 py-3 rounded-full border border-foreground/20 text-foreground text-sm font-semibold hover:bg-foreground/5 transition-all"
                  >
                    Sign In
                  </Button>
                </motion.div>
